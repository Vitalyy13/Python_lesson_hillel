...
class Student(Human):
    ...
    # чтобы Student корректно жил в set (по зачётке)
...
class Group:
    ...
    def add_student(self, student):
        ...
        if len(self.group) >= 10:
            raise GroupLimitError("Нельзя добавить: в группе уже 10 студентов!")
...
try:
    for i in range(3, 12):  # на последнем шаге будет попытка добавить 11-го
